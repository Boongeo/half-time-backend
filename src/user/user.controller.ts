import { Body, Controller, Get, Inject, Patch, Post, Put, UploadedFile, UseInterceptors } from '@nestjs/common';
...
export class UserController {
  ...
  async register(
    ...
    return this.userService.registerProfile(user, nickname, profileImage);
  }
